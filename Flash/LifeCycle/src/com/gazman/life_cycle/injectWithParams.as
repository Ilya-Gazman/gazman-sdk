...
package com.gazman.life_cycle
{
	 ...
	 * @param params constractor parameters
	 * @param family used for singleton pattern to have more than one singleton from same type in the system
	 * @return instance of @classToReturn 
	 * @see http://en.wikipedia.org/wiki/Multiton_pattern
	 */
	public function injectWithParams(classToReturn:Class, params:Array, family:String = null):*{
		return Factory.instance.inject(classToReturn, family, params);
	}
}

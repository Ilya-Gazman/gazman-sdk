...
package com.gazman.ui.layouts
{
	...
	public class Layout
	{
		...
		protected var xValue:Number, yValue:Number;
		 ...
		 */		
		public final function applyLayoutOn(target:DisplayObject, relativeTo:DisplayObject):void{
			if(target.parent == relativeTo.parent){
				xValue = relativeTo.x;
				yValue = relativeTo.y;
			}
			else{
		...
		protected function applyLayoutHandler(target:DisplayObject, relativeTo:DisplayObject):void
		{
		}
